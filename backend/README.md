...
## Project Structure
    ...
    ├── testapiautoconnect_112265  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_112265`
...
2. Clone this repo and `cd testapiautoconnect_112265`
